...
namespace TeamBuilderPkmnASP.Controllers
{
    public class PokemonsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,identifier,species_id,order,is_default")] Pokemon pokemon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,identifier,species_id,order,is_default")] Pokemon pokemon)
        {
            if (id != pokemon.Id)
            {
                return NotFound();
